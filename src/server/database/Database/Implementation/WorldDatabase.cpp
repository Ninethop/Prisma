...
void WorldDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(WORLD_REP_PRISMA_TEMPLATE, "REPLACE INTO creature_template (entry, modelid1, name, faction, scale, unit_class, unit_flags) VALUES (?, ?, ?, ?, ?, 1, 33554432)", CONNECTION_ASYNC);
}
